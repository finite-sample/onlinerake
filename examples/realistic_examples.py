...
def example_2_streaming_polls():
    ...
    for n, margins in margin_history:
        print(f"{n:<6} {margins['age']:<8.3f} {margins['gender']:<8.3f} "
...
def example_3_comparative_analysis():
    ...
    print("-" * 50)
    print(f"{'Loss (sq error)':<20} {'':<10} {sgd_raker.loss:<10.6f} {mwu_raker.loss:<10.6f}")
    print(f"{'Effective Sample Size':<20} {'':<10} {sgd_raker.effective_sample_size:<10.1f} {mwu_raker.effective_sample_size:<10.1f}")
    ...
    for char in ['age', 'gender', 'education', 'region']:
        ...
        print(f"{char}: SGD {sgd_improvement:.1f}% improvement, MWU {mwu_improvement:.1f}% improvement")
